...
import { MInputMask } from '@ulaval/modul-components/dist/components/input-mask/input-mask';
import { modulComponentsHierarchyRootSeparator } from '../../../utils';

storiesOf(`${modulComponentsHierarchyRootSeparator}m-input-mask`, module)
