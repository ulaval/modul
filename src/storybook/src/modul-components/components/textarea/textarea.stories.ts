...
import { TEXTFIELD_NAME } from '@ulaval/modul-components/dist/components/component-names';
import { MTextfieldType } from '@ulaval/modul-components/dist/components/textfield/textfield';
...
storiesOf(`${modulComponentsHierarchyRootSeparator}${TEXTFIELD_NAME}/Counter`, module)
...
storiesOf(`${modulComponentsHierarchyRootSeparator}${TEXTFIELD_NAME}/max-width`, module)
...
storiesOf(`${modulComponentsHierarchyRootSeparator}${TEXTFIELD_NAME}/tag-style`, module)
