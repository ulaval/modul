...
import { INPLACE_EDIT_NAME } from '@ulaval/modul-components/dist/components/component-names';
...
storiesOf(`${modulComponentsHierarchyRootSeparator}${INPLACE_EDIT_NAME}`, module)
    ...
    .add('default', () => ({
        ...
        methods: {
            onClick(): void {
                (this as any).$data.editMode = true;
            }
        },
...
storiesOf(`${modulComponentsHierarchyRootSeparator}${INPLACE_EDIT_NAME}/mobile`, module)
...
storiesOf(`${modulComponentsHierarchyRootSeparator}${INPLACE_EDIT_NAME}/tag-style`, module)
