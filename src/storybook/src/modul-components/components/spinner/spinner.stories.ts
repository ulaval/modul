...
import { SPINNER_NAME } from '@ulaval/modul-components/dist/components/component-names';
import { MSpinnerSize, MSpinnerStyle } from '@ulaval/modul-components/dist/components/spinner/spinner';
import { modulComponentsHierarchyRootSeparator } from '../../../utils';



storiesOf(`${modulComponentsHierarchyRootSeparator}${SPINNER_NAME}`, module)
    .add('default', () => ({
...
storiesOf(`${modulComponentsHierarchyRootSeparator}${SPINNER_NAME}/skin`, module)
    .add('skin="regular"', () => ({
...
storiesOf(`${modulComponentsHierarchyRootSeparator}${SPINNER_NAME}/size`, module)
    .add('size="small"', () => ({
...
storiesOf(`${modulComponentsHierarchyRootSeparator}${SPINNER_NAME}/knobs`, module)
