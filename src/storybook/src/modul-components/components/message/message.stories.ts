...
storiesOf(`${modulComponentsHierarchyRootSeparator}${MESSAGE_NAME}/skin="default"`, module)
...
storiesOf(`${modulComponentsHierarchyRootSeparator}${MESSAGE_NAME}/skin="light"`, module)
...
storiesOf(`${modulComponentsHierarchyRootSeparator}${MESSAGE_NAME}/skin="page-light"`, module)
...
storiesOf(`${modulComponentsHierarchyRootSeparator}${MESSAGE_NAME}/skin="page"`, module)
