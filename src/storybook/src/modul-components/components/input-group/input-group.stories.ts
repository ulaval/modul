...
import { INPUT_GROUP_NAME } from '@ulaval/modul-components/dist/components/component-names';
import { modulComponentsHierarchyRootSeparator } from '../../../utils';


storiesOf(`${modulComponentsHierarchyRootSeparator}${INPUT_GROUP_NAME}`, module)
...
storiesOf(`${modulComponentsHierarchyRootSeparator}${INPUT_GROUP_NAME}/validation-message-position`, module)
    .add('top', () => ({
