...
storiesOf(`${modulComponentsHierarchyRootSeparator}${FORM_NAME}`, module)
    .add('default', () => ({
        methods: {
            submit: () => {
    ...
    .add('reactive initial value', () => ({
        ...
        methods: {
            submit(value: string): void {
                Vue.prototype.$log.log('submited');
                (this as any).$data.formGroup.getControl('name').initalValue = value;
            },
            reset(): void {
                Vue.prototype.$log.log('reseted');
            },
            resetToNewValue(): void {
                (this as any).$data.formGroup.getControl('name').reset('newValue');
...
storiesOf(`${modulComponentsHierarchyRootSeparator}${FORM_NAME}/built-in action-fallouts`, module)
    ...
    .add('toast message for form group validations', () => ({
        data: () => ({
            formGroup: new FormGroup({
...
storiesOf(`${modulComponentsHierarchyRootSeparator}${FORM_NAME}/validators`, module)
...
storiesOf(`${modulComponentsHierarchyRootSeparator}${FORM_NAME}/validation-type`, module)
...
storiesOf(`${modulComponentsHierarchyRootSeparator}${FORM_NAME}/rules`, module)
...
storiesOf(`${modulComponentsHierarchyRootSeparator}${FORM_NAME}/all fields`, module)
    ...
    .add('autocomplete', () => ({
        ...
        methods: {
            onComplete(): void {
                (this as any).$data.autocompleteResults = [...(this as any).$data.autocompleteResults];
            }
        },
        computed: {
