...
storiesOf(`${modulComponentsHierarchyRootSeparator}${ICON_BUTTON_NAME}`, module)
...
storiesOf(`${modulComponentsHierarchyRootSeparator}${ICON_BUTTON_NAME}/skin`, module)
...
storiesOf(`${modulComponentsHierarchyRootSeparator}${ICON_BUTTON_NAME}/all props`, module)
