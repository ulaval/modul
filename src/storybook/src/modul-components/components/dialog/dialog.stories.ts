...
storiesOf(`${modulComponentsHierarchyRootSeparator}${DIALOG_NAME}/state`, module)
    .add('default', () => ({
        data: () => ({
            openProp: true
        }),
...
storiesOf(`${modulComponentsHierarchyRootSeparator}${DIALOG_NAME}/Btn-Link Combos`, module)
