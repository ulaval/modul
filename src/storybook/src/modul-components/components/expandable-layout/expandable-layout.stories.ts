...
storiesOf(`${modulComponentsHierarchyRootSeparator}${EXPANDABLE_LAYOUT_NAME}`, module)
    ...
    .add('default', () => ({
        ...
        <m-expandable-layout :open="open" :panel-scroll-mode="panelScrollMode" :panel-position="panelPosition" :panel-width="panelWidth" :over-content="overContent">
            <div :style="{background: 'lightgrey', height: mainContentHeight}"><p class="mu-h3 mu-no-m">Main content</p>Lorem ipsum, or lipsum as it is sometimes known, is dummy text used in laying out print, graphic or web designs. The passage is attributed to an unknown typesetter in the 15th century who is thought to have scrambled parts of Cicero's De Finibus Bonorum et Malorum for use in a type specimen book. It usually begins with:<br/>
            ...
            <div slot="panel" :style="{height: panelContentHeight}" style="background: yellow;"><p class="mu-h3 mu-no-m">Panel content</p>HISTORY<br/>PURPOSE<br/>USAGE</div>
        </m-expandable-layout>`
    }))
    .add('open', () => ({
