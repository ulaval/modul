...
import boldIcon from '../svg/Froala-bold.svg';
import listsIcon from '../svg/Froala-lists.svg';
import replaceIcon from '../svg/Froala-replace.svg';
import specialCharsIcon from '../svg/Froala-special-charracters.svg';
import stylesIcon from '../svg/Froala-styles.svg';
import titleIcon from '../svg/Froala-title.svg';
