...
import NavbarPlugin, { MNavbarSkin } from './navbar';
...
storiesOf(`${componentsHierarchyRootSeparator}${NAVBAR_NAME}`, module)
...
storiesOf(`${componentsHierarchyRootSeparator}${NAVBAR_NAME}/skin`, module)
    .addDecorator(storyRouterDecorator())
