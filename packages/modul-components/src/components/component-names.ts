...
export const MULTI_SELECT_NAME: string = 'm-multi-select';
...
export const RESPONSIVE_TABLE_NAME: string = 'm-responsive-table';
...
export const TABLE_HEAD_NAME: string = 'm-table-head';
export const TABLE_GROUP_NAME: string = 'm-table-group';
export const TABLE_GROUP_HEADER_NAME: string = 'm-table-group-header';
export const TABLE_EMPTY_ROW_NAME: string = 'm-table-empty-row';
...
export const TYPEAHEAD_NAME: string = 'm-typeahead';
...
export const SVG_NAME: string = 'm-svg';
